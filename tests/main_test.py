...
params: dict = utils.file_to_dict(os.path.join('conf_test', 'config_test.yaml'))
MISSING_DATE_CHECK_PERIOD: int = params['MISSING_DATE_CHECK_PERIOD']
LOG_CONFIG_FILE_PATH: str = os.path.join('conf_test', 'logger_test.yaml')
PRODUCTION_CONFIG_FILE_PATH: str = os.path.join('conf_test', 'production_test.yaml')
